...
module.exports = Drawable = (function() {
  ...
  Drawable.prototype.font = "12pt 'Josefin Sans'";

  Drawable.prototype.fontColor = "#FFFFFF";

  Drawable.prototype.animate = false;

  Drawable.prototype.animations = [];
  ...
  function Drawable(config) {
    ...
    this.getAsset = bind(this.getAsset, this);
    this.getAssets = bind(this.getAssets, this);
    this.removeAsset = bind(this.removeAsset, this);
  ...
  Drawable.prototype.invoke = function(event, arg1, arg2) {
    if (this.events[event] != null) {
      return this.events[event].call(this, arg1, arg2);
    }
  };
  ...
  Drawable.prototype.doDraw = function(scene, ctx) {
    ...
    if (this.children.length > 0) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        asset = ref[i];
        results.push(asset.doDraw(scene, ctx));
      }
      return results;
    }
  };
  ...
  Drawable.prototype.removeAsset = function(assetToRemove) {
    var items;
    items = _.filter(this.children, (function(_this) {
  ...
  Drawable.prototype.getAssets = function(name) {
    return _.filter(this.children, (function(_this) {
      return function(asset) {
  ...
  Drawable.prototype.getAsset = function(name) {
    return _.find(this.children, (function(_this) {
      return function(asset) {
        return asset.name === name;
      };
    })(this));
...
GameEngine = (function() {
  ...
  GameEngine.prototype.doDraw = function() {
    ...
    if (this.activeScene != null) {
      ...
      return (ref = this.activeScene) != null ? ref.doDraw(this.activeScene, this.ctx) : void 0;
    }
  };
